...
var Card = React.forwardRef(function (_a, ref) {
    ...
    return (<div ref={ref} className={(0, utils_1.cn)("bg-card text-card-foreground rounded-lg border shadow-sm", className)} {...props}/>);
});
exports.Card = Card;
...
var CardDescription = React.forwardRef(function (_a, ref) {
    var className = _a.className, props = __rest(_a, ["className"]);
    return (<div ref={ref} className={(0, utils_1.cn)("text-muted-foreground text-sm", className)} {...props}/>);
});
