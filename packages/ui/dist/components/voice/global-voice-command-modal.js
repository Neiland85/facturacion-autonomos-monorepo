...
exports.default = GlobalVoiceCommandModal;
var framer_motion_1 = require("framer-motion");
var alert_triangle_1 = require("../ui/alert-triangle");
var button_1 = require("../ui/button");
var dialog_1 = require("../ui/dialog");
var info_1 = require("../ui/info");
var loading_spinner_1 = require("../ui/loading-spinner");
function GlobalVoiceCommandModal(_a) {
    var isOpen = _a.isOpen, onClose = _a.onClose, isListening = _a.isListening, transcript = _a.transcript, feedbackMessage = _a.feedbackMessage, error = _a.error, startListening = _a.startListening, stopListening = _a.stopListening, hasSupport = _a.hasSupport;
    var descriptionId = "global-voice-command-description";
