...
import GlobalVoiceCommandModal from '@/components/global-voice-command-modal'
import { Button } from '@/components/ui/button'
import VoiceInvoiceModal from '@/components/voice-invoice-modal'
...
export default function VoiceHeader({ onCreateInvoice, className = "" }: VoiceHeaderProps) {
