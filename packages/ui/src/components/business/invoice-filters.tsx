            ...
            <div className="flex flex-wrap gap-2">
              {statusOptions.map((option) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-medium transition-colors ${filters.status === option.value
                    ? option.color
            ...
            <div className="flex flex-wrap gap-2">
              {paymentStatusOptions.map((option) => (
                <button
                  ...
                  className={`px-3 py-1 rounded-full text-xs font-medium transition-colors ${filters.paymentStatus === option.value
                    ? option.color
                    : 'bg-gray-50 text-gray-600 hover:bg-gray-100'
                    }`}
                >
