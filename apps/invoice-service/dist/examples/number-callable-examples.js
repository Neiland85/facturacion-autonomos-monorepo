...
const numeroTipado = 42;
// Signaturas de métodos de instancia
const callableTipadoDemo = numeroTipado.toCallable();
const valorInvocadoDemo = numeroTipado.invoke();
const valorJSONDemo = numeroTipado.toJSON();
// Signaturas de propiedad json
const jsonStringDemo = numeroTipado.json.stringify();
const numeroParseadoDemo = numeroTipado.json.parse();
const objetoTipadoDemo = numeroTipado.json.toObject();
const numeroDesdeObjetoDemo = numeroTipado.json.fromObject({
    value: 99,
    type: 'number',
});
// Signaturas de métodos estáticos
const numeroCallableTipadoDemo = Number.callable(77);
const numeroDesdeCallableDemo = Number.fromCallable(() => 88);
...
//# sourceMappingURL=number-callable-examples.js.map