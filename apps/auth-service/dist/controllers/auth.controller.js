...
export class AuthController {
    ...
    refresh = async (req, res) => {
        try {
            ...
            try {
                ...
                const isValidRefreshToken = await this.jwtService.verifyRefreshToken(refreshToken);
                ...
                const accessToken = await this.jwtService.refreshAccessToken(refreshToken);
                // Actualizar cookie
    ...
    setup2FA = async (req, res) => {
        try {
            ...
            const secret = await this.twoFactorService.generateTwoFactorSecret(user.id, user.email);
            res.json({
                success: true,
