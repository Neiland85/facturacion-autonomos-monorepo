...
export const HomeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.121 0l8.955 8.955M3 10.5v8.25c0 .828.672 1.5 1.5 1.5h3.75a.75.75 0 00.75-.75V15a.75.75 0 01.75-.75h2.5a.75.75 0 01.75.75v5.25a.75.75 0 00.75.75h3.75a1.5 1.5 0 001.5-1.5V10.5M8.25 21V15" />
  </svg>
);
...
export const AwardIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 12h7.5M12 15.75V8.25" />
  </svg>
);
...
export const CameraIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.219 2.219 0 015.186 7.75c-.211.06-.415.146-.612.256a.75.75 0 01-.728-.914 2.25 2.25 0 012.25-1.542zM12 12.75a2.25 2.25 0 100-4.5 2.25 2.25 0 000 4.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 12a6.375 6.375 0 11-12.75 0 6.375 6.375 0 0112.75 0zM12 15.75a.75.75 0 00-1.488-.135A3.375 3.375 0 0012 15.75zm0 0a.75.75 0 011.488-.135A3.375 3.375 0 0112 15.75z" />
...
export const DocumentChartBarIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9l-.621-.621A3 3 0 0115 18.257V17.25m-6 0h6M9 11.25h6M9 7.5h6M12 21.75c-4.97 0-9-4.03-9-9s4.03-9 9-9 9 4.03 9 9-4.03 9-9 9z" />
    </svg>
);