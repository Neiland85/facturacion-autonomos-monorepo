...
import VoiceHeader from './voice-header';
            ...
            <CardContent>
              {invoices.length === 0 ? (
                <p className="text-gray-500 text-center py-4">
                  No hay facturas creadas aún. Usa los comandos de voz para
                  crear una.
                </p>
              ) : (
                <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-3">
                  Haz clic en el botón de micrófono (🎤) en el header para
                  acceder a comandos globales.
                </p>
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mb-3">
                  Haz clic en el botón de documento (📄) para crear facturas
